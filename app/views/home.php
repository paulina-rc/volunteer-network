...
<body>
    <div style="max-width:900px;margin:0 auto;padding:40px 24px 80px;text-align:center">
        ...
        <div class="banner-estado">
            ...
            Conexión a la base de datos exitosa — <?= count($categorias) ?> categorías cargadas desde MySQL
        </div>

        <h1 style="color:var(--color-primario);font-size:22px;margin-bottom:6px">Base del proyecto lista</h1>
        <p style="color:#5c5c58;font-size:14.5px;max-width:560px;margin:0 auto 36px">
            ...
            y el primer modelo (<code>CategoriaModel</code>) funcionan de punta a punta.
        ...
        <div class="grid-categorias">
            <?php foreach ($categorias as $categoria): ?>
                <div class="tarjeta-categoria">
                    <div class="icono" style="background:<?= htmlspecialchars($categoria['color_hex']) ?>">
                        <i class="fa-solid <?= htmlspecialchars($categoria['icono']) ?>"></i>
                    </div>
                    <div style="font-size:13.5px;font-weight:600;color:var(--color-primario)">
